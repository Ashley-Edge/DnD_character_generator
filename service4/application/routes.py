...
def weapon():
    weapons = {
        "a Dwarf" : {"Barbarian" : "a battle axe", "Bard" : "a light hammer", "Cleric" : "a club"},
        "an Elf" : {"Barbarian" : "a long sword", "Bard" : "a rapier", "Cleric" : "a long crossbow"},
        "a Halfling" : {"Barbarian" : "a club", "Bard" : "an enchanted lute", "Cleric" : "a dagger"}
    }
    info = request.json 
